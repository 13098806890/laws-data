...
_CIVIL_SUBGROUPS = [
    ('民法典',         ['民法典']),
    ('合同·债权',      ['合同', '债权', '债务', '买卖', '租赁', '借款', '票据']),
    ('公司·破产',      ['公司', '企业破产', '清算', '个人独资', '合伙企业', '农民专业合作社']),
    ('知识产权',       ['知识产权', '专利', '商标', '著作权', '版权', '不正当竞争']),
    ('担保·物权',      ['担保', '物权', '抵押', '质押', '留置', '不动产登记']),
    ('婚姻·家庭·继承', ['婚姻', '家庭', '继承', '收养', '监护', '人身安全保护']),
    ('海事·运输',      ['海商', '海事', '运输', '航运', '船舶', '港口']),
    ('外商·涉外',      ['外商投资', '中外合资', '涉外', '外资']),
    ('证券·期货',      ['证券', '期货', '基金', '股票', '上市', '期权']),
    ('综合·程序批复',  []),  # 兜底
]
...
_ECON_SUBGROUPS = [
    ...
    ('贸易·竞争·市场', ['贸易', '竞争', '市场', '反垄断', '招标', '政府采购', '对外贸易', '海关']),
    ('农业·资源·能源', ['农业', '渔业', '林业', '矿产', '能源', '石油', '煤炭', '电力', '土地']),
    ('其他经济法规',  []),
]

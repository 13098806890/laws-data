...
| **B4. 全量翻译** | ✅ 完成 | T0 ✅ T1 ✅ T2 ✅ T3 ✅ T4 ✅（累计 47,315 条英文，656 部法律）|
| **B5. 脚本改造** | ✅ 完成 | translate_to_en.py 支持 --tier/--max-laws-per-run/按需注入/截断JSON恢复 |
| **B6. 一致性校验** | ⏳ 待开发 | - |
...
| **已翻译条文** | 完成 | **47,315 条**英文（656 部法律，T0-T4 全部完成），待翻译约 **14,450 条**（T5）|
...
**下一步：**
1. ✅ T0 全部 11 部（3,351 条）
2. ✅ T1 全部 23 部（3,356 条）
3. ✅ T2 全部 58 部（5,241 条）
4. ✅ T3 全部 106 部（7,513 条）
5. ✅ T4 全部 458 部（19,101 条）
6. ⏳ T5 全部 603 部（14,450 条）
7. ⏳ C2 英文 FTS 表（nodes_fts_en）
8. ⏳ B6 一致性校验脚本

> **费用参考：** T0-T3 全部使用 DeepSeek API，batch-size 20，总计约 13,832 条英文。T4（454 部，~19,101 条）如继续使用 DeepSeek，预计成本约 **$2-3 USD**。
...
**当前进度（2026-07-06）：**
- 法律总数：1,259 部（is_current=1）
- 已完整翻译：656 部（T0/T1/T2/T3/T4 全部完成）
- 已翻译条文：47,315 条英文
- 待翻译条文：~14,450 条（T5，589 部）
- 进行中：T5（全部翻译）

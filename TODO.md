...
| **B4. 全量翻译** | ✅ 完成 | T0 ✅ T1 ✅ T2 ✅ T3 ✅（累计 17,870 条英文，227 部法律）|
...
| **已翻译条文** | 完成 | **17,870 条**英文（227 部法律，T0-T3 全部完成），待翻译约 39,297 条（T4-T5）|
...
**下一步：**
1. ✅ T0 全部 11 部（3,863 条）
2. ✅ T1 全部 23 部（3,862 条）
3. ✅ T2 全部 58 部（5,741 条）
4. ✅ T3 全部 106 部（4,404 条）
5. ⏳ T4 按需翻译（454 部，~19,101 条）
6. ⏳ C2 英文 FTS 表（nodes_fts_en）
7. ⏳ B6 一致性校验脚本
...
- 已完整翻译：227 部（T0/T1/T2/T3 全部完成）
- 已翻译条文：17,870 条英文
- 待翻译条文：~39,297 条（T4 + T5）
- 下一批：T4（按需翻译，454 部）

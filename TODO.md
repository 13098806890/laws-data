...
| **B4. 全量翻译** | ⏳ 进行中 | T0 ✅ T1 ✅ T2 ✅（累计 ~10,600 条英文，62+58=120 部法律）|
...
**下一步：**
1. ✅ T0 全部 11 部（4,038 条）
2. ✅ T1 全部 23 部（1,970 条）
3. ✅ T2 全部 58 部（4,154 条）
4. ⏳ T3 翻译（106 部，~3,500 条）
5. ⏳ C2 英文 FTS 表（nodes_fts_en）
6. ⏳ B6 一致性校验脚本

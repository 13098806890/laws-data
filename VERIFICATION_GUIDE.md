...
```bash
# 查看修复后的效果
grep -A 10 "第三十四条" /Users/doxie/Github/laws-data/民事与商事/民法典/中华人民共和国民法典.md
```
...
sqlite3 /Users/doxie/Github/laws-data/law_content.db "
...
```bash
# 在 VS Code 中打开民法典
code "/Users/doxie/Github/laws-data/民事与商事/民法典/中华人民共和国民法典.md"
```
